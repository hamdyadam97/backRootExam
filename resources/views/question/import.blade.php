...
@section('content')
                ...
                <div class="card-body">
                    @if($errors->any())
                        @foreach($errors->all() as $err)
                            <label class="d-block alert alert-danger">{{ $err }}</label>
                        @endforeach
                    @endif
                    <form method="post" class="form-horizontal" action="{{ route('question.importFile') }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="file" id="csv_file" class="form-control hint" name="csv_file"
                                           value="{{ old('csv_file') }}">
                        ...
                        <button type="submit" class="btn btn-success waves-effect waves-light mt-2" id="importBtn">
                            Import'
                        </button>
                    </form>
                </div>
    ...
    <div class="add_html_answer_option d-none">
        <div class="row answer_option_div mt-3">
            ...
            <div class="col-md-2">
                <button type="button" class="btn btn-danger remove_answer_option"><i class="mdi mdi-delete"></i>
                </button>
            </div>
        </div>
    </div>
