                ...
                <div class="card-body">
                    ...
                    <form id="add-form" method="post" class="form-horizontal"
                        ...
                        <div class="row">
                            ...
                            {{--                                    @endforeach --}}
                            {{--                                </select> --}}
                            {{--                                <span class="invalid-feedback" id="exam_idError" data-ajax-feedback="exam_id" role="alert"></span> --}}
                            {{--                            </div> --}}
                            {{--                        </div> --}}
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select required name="sub_subcategory_id" id="sub_subcategory_id"
                                            class="form-control select2 category_id"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="section_id[]" id="section_id" class="form-select select2 section_id"
                                            multiple placeholder="@lang('Select Exam Section')">
                                        <option value="">Select Exam Section</option>
                                        {{-- @foreach ($sections as $section)
                                            <option value="{{ $section->id }}">{{ $section->name }}</option>
                                        @endforeach --}}
                                    </select>
                                    <span class="invalid-feedback" id="section_idError" data-ajax-feedback="section_id"
                                          role="alert"></span>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <select name="question_type" id="question_type" class="form-select question_type">
                                        @if ($questionType)
                                            @foreach ($questionType as $key1 => $row1)
                                                <option
                                                    value="{{ $key1 }}" {{ $key1 == 2 ? "selected":""  }}>{{ $row1 }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="questions_topic_id[]" id="questions_topic_id"
                                        ...
                                        {{-- @foreach ($questionTopics as $questionTopic)
                                            <option value="{{ $questionTopic->id }}">{{ $questionTopic->topic }}</option>
                                        @endforeach --}}
                                    </select>
                                </div>
                            </div>
                            ...
                            @for ($i = 0; $i <= 4; $i++)
                                <div class="col-md-6">
                                    ...
                                    <textarea id="correct_answer_editor{{ $i }}"
                                              ...
                                              name="correct_answer_editor[]" rows="3"></textarea>
