...
return [
  ...
  "Note" => "Note",
  "Rating" => "Rating",
  "Filter_zurücksetzen" => "Filter zurücksetzen",
  ...
  "inkl. Mwst & Lieferung"=>"inkl. Mwst & Lieferung",
  ...
  "Filter By Anschlüsse"=>"Filter By Anschlüsse",
  "Select Anschlüsse"=>"Select Anschlüsse",
  "Filter By Ausführung"=>"Filter By Ausführung",
  "Select Ausführung"=>"Select Ausführung",
