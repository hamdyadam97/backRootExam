                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor" class="form-control" name="notes" rows="3">{{@$question_answers->notes}}</textarea>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select name="show_answer" id="show_answer"
                                        ...
                                        <option value="0" {{ $question_answers->show_answer == '0' ? 'selected':'' }}>
                                            No
                                        </option>
                                        <option value="1" {{ $question_answers->show_answer == '1' ? 'selected':'' }}>
                                            Yes
                                        </option>
                                    </select>
